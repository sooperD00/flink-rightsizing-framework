...
Usage:
    python 1_classify.py                                    # default paths
    python 1_classify.py --input data/staging/snapshot_latest.json
    python 1_classify.py --stdout                           # print to stdout instead

# chained with observe:
python 0_observe.py && python 1_classify.py

# crontab: every 5 minutes
*/5 * * * * cd /opt/flink-rightsizing && python 0_observe.py && python 1_classify.py
"""
